...
const CreateVibhag = () => {
  ...
  const submitHandler = async (e) => {
    ...
    try {
      const { data } = await axios.post(`${apibaseUrl}vibhag/create`, {
        name: user.name,
      });
      ...
      <ul className="nav-style1">
        ...
        <li>
          <Link to="/create-vibhag">
            <a className="active">विभाग जोड़ें</a>
          </Link>
        </li>
      </ul>
      <div>
          ...
          <section className="signup">
            <div className="container1">
              <div className="signup-content">
                ...
                >
                  <h2 className="form-title"> विभाग जोड़ें </h2>
                  ...
                  <div className="form-group">
                    <input
                      ...
                      value={isSubmiting ? "विभाग जोड़ा जा रहा है..." : "जोड़ें"}
                    />
                  </div>
                </form>
              </div>
