...
const columns = [
  ...
  { field: "id", headerName: "आई डी", width: 150 },
  { field: "daitva_of", headerName: "दायित्व क्षेत्र", width: 150 },
  { field: "name", headerName: "दायित्व", width: 190 },
...
const DaitvaScreen = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      setLoading(true);
      try {
        const { data } = await axios.get(`${apibaseUrl}/get/daitva`);
