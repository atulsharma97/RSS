...
const columns = [
  ...
  { field: "name", headerName: "शिक्षण", width: 300 },
];
...
const ShikshanScreen = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      setLoading(true);
      try {
        const { data } = await axios.get(`${apibaseUrl}/get/shikshan`);
